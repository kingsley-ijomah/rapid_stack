...
class GraphQLHandler {
  ...
  async createQuery(serviceName, responseKeys) {
    ...
    const queriesFolderName = `${snakeCaseName}_queries`;
    const queriesFolderPath = path.join('backend', 'app', 'graphql', 'queries', queriesFolderName);
  ...
  async createService(serviceName, serviceAnswers) {
    ...
    this.generator.fs.copyTpl(
      ...
      serviceFilePath,
      {
        ...
        apiHost: serviceAnswers.apiHost,
        apiKey: serviceAnswers.apiKey,
