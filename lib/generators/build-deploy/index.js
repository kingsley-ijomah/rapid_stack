...
const { handlePrompt, getConfigField, createGitHubRepos, initializeAndPushGitRepo, updateGitHubSecrets, deleteGitHubRepos } = require('../../lib/utils');
...
module.exports = class extends BaseGenerator {
  ...
  async _handleDeletion() {
    ...
    try {
      ...
      this.log('✓ Repository deletion completed');
    } catch (error) {
      this.log('❌ Error deleting repositories:', error.message);
      process.exit(1);
    }
  }
